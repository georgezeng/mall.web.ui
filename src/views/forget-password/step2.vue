    ...
    <Layout :style="commonStyles.layout">
        ...
        <Content :style="commonStyles.content">
            <Form ref="form" style="margin-top: 100px; padding: 20px;" :model="form" :rules="rules" :label-width="75">
                ...
                <x-button action-type="button" :disabled="loading" style="width: 100%; background-color: #FF992D;" :show-loading="loading" @click.native="reset">
        ...
        methods: {
            reset() {
                if(!this.info || !this.info.username) {
                    this.$vux.toast.show({text: '没有提交手机号，请重新提交', type: 'text', width: '250px'})
                    this.back()
                    return
                }
