...
<template>
    <Layout :style="commonStyles.layout">
        ...
        <Content :style="contentStyle">
            ...
            <div align="center" style="margin: 15px 0px 5px;">
                <a v-if="config.env != 'production'" style="color: darkgray;" href="http://www.beian.miit.gov.cn" target="_blank">粤ICP备17125109号-1</a>
                <a v-else style="color: darkgray;" href="http://www.beian.miit.gov.cn" target="_blank">粤ICP备17125109号-2</a>
            </div>
        </Content>
